                    ...
                    <div class="container abc">
                        <div class="collapse navbar-collapse">
                            <ul class="nav navbar-nav pull-right">
                                ...
                                <li><a class="smooth-scroll" href="add-note.php">Sell Your Notes</a></li>
                                <li><a class="smooth-scroll" href="faq.php">FAQ</a></li>
                                <li><a class="smooth-scroll" href="contact-us.php">Contact Us</a></li>
                                <li><a class="smooth-scroll" href="#"><button type="submit" href="login.php"class="btn2 btn-default">Login</button></a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- Mobile Menu -->
